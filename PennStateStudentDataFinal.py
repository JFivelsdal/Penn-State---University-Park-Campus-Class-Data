...
#hiPlotTable = plt.table(cellText = hairDyePivot[1:2],colWidth = [0.1] * 3)

#plt.title('Chi-Squared Distribution With One Degree of Freedom  $\chi^2(1)$',size = 20)
...
plt.legend()
#plt.plot(0,criticalChi)
#plt.fill_betweenx(yChi,xChi,4.52, where= xChi > 4.52,color = 'red')
#plt.fill_betweenx()


#print xChi
print np.random.chisquare(1,len(np.arange(0,20)))
plt.show()
